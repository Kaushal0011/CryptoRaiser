    ...
    return (
        ...
        gap-6"> 
            ...
            items-center relative">
                ...
                bg-[#1c1c24] z-10 shadow-secondary [y-4] 
                        ...
                        {navlinks.map((link) => (
                            ...
                            >
                                <img 
                                    ...
                                    object-contain ${isActive === link.name ?
                                     'grayscale-0' : 'grayscale'}`}
                                />
                                <p className={`ml-[20px] font-epilogue 
                                font-semibold text-[14px] ${isActive === link.name
